...
public class CalculatorTest {
    ...
    public void factorialFalsePositive(){
        ...
        assertNotEquals("Finding factorial of a number for False Positive", 113, calculator.factorial(1), DELTA);
        assertNotEquals("Finding factorial of a number for False Positive", 10, calculator.factorial(2), DELTA);
        assertNotEquals("Finding factorial of a number for False Positive", 42, calculator.factorial(3), DELTA);
        assertNotEquals("Finding factorial of a number for False Positive", 9, calculator.factorial(4), DELTA);
        assertNotEquals("Finding factorial of a number for False Positive", 77, calculator.factorial(5), DELTA);
        assertNotEquals("Finding factorial of a number for False Positive", 33, calculator.factorial(6), DELTA);
    }
